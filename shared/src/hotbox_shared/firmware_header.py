...
def render_firmware_header(system: SystemConstants) -> str:
    ...
    lines.extend(
        ...
        f"#define HOTBOX_HOME_AZIMUTH_DEG ({system.actuator.home_azimuth_deg:.6f}f)",
        f"#define HOTBOX_HOME_ELEVATION_DEG ({system.actuator.home_elevation_deg:.6f}f)",
        f"#define HOTBOX_HOMING_DIRECTION_AZIMUTH ({int(system.actuator.homing_direction_azimuth)})",
        f"#define HOTBOX_HOMING_DIRECTION_ELEVATION ({int(system.actuator.homing_direction_elevation)})",
        ...
        f"#define HOTBOX_HALL_WINDOW_WIDTH_DEG ({system.actuator.hall_window_width_deg:.6f}f)",
        f"#define HOTBOX_HALL_WINDOW_TOLERANCE_DEG ({system.actuator.hall_window_tolerance_deg:.6f}f)",
        ...
        f"#define HOTBOX_PID_VELOCITY_KP ({system.actuator.pid_velocity_kp:.6f}f)",
        f"#define HOTBOX_PID_VELOCITY_KI ({system.actuator.pid_velocity_ki:.6f}f)",
        f"#define HOTBOX_PID_VELOCITY_KD ({system.actuator.pid_velocity_kd:.6f}f)",
