...
constexpr float kPidVelocityKp          = HOTBOX_PID_VELOCITY_KP;
constexpr float kPidVelocityKi          = HOTBOX_PID_VELOCITY_KI;
constexpr float kPidVelocityKd          = HOTBOX_PID_VELOCITY_KD;
